...
def evaluate_non_violent_only(test_dir):

    folder_path = os.path.join(test_dir, "non_violent")
    ...
    print("\n====================")
    print("TOTAL NON_VIOLENCE_VIDEOS:", total)
    print("DETECTED AS NONE:", correct)
    print("MISS RATE:", round(false_positive / total, 3))
    print("====================")
...
if __name__ == "__main__":
    evaluate_non_violent_only("performance_test/dataset")